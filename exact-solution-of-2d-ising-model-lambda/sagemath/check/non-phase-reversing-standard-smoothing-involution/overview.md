...
位相寄与 $\mathcal W^{a,b}_L$ を保つこと、および各 $(D,E)$ ファイバーで
回転差 $-4$ と $4$ の二部分の位相和が等しいことを検査する。
...
- 結果: 一辺 $L=2$ で $\mathcal A_L^{(-4)}$ と $\mathcal A_L^{(4)}$ は各 $3{,}616$ 個だった。
  ...
  全数検査した（位相寄与の検査 $28{,}928$ 件）。さらに、これらが現れる $129$ ファイバーと
  四つのスピン構造について、回転差二部分の位相和の相等 $516$ 件を全数検査した。
