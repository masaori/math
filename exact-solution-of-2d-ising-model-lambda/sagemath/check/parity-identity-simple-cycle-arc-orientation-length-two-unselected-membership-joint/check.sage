"""既存 7,085 鍵で語長二の非切断項に単一辺所属と二重辺所属だけからなる全ての積を許す有限判定。

対象ラベル: claim_kac_ward_determinant_fiber_stratified_phase_sum
一般の辺長と全語長についての命題ではない。
"""
print("LOAD: constructing finite key data", flush=True)
load("sagemath/check/parity-identity-simple-cycle-arc-orientation-length-two-unselected-membership-joint/construction.sage")
...
system, system_rhs, blocks = length_two_unselected_membership_joint_system(entries, rhs, all_types, column_index)
...
print("PASS: length-two unselected-membership joint decision and certificate", flush=True)
