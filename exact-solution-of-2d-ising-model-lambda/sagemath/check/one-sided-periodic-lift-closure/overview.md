...
- 状態: PASS（2026-09-21）。非零巻き付きの頂点単純閉路 3,464 本、一側閉包 45,216 本について、単位歩 1,210,464 件、終点を除く頂点の相異性 1,210,464 件、射影後の循環総回転数 45,216 件を全列挙した。循環総回転数は全て $\{+4,-4\}$ に属し（この構成・列挙順では全例が $+4$）、周期数 $1,2,3$ の二つの隣接差も全て元の閉歩道の循環総回転数に一致した。
