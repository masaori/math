...
（これより古い 230 件は [auto-loop-archive.md](auto-loop-archive.md) へ移した。）
...
| 章 | セクション | 状態 | 備考 |
|---|---|---|---|
| 熱力学極限 | 周期境界と開境界の境界評価 | 記述と SageMath まで | 境界を横切る辺は $2L$ 本。Lean 未着手 |
...
（これより古い 241 件は [auto-loop-archive.md](auto-loop-archive.md) へ移した。）
