...
E_{L,\mathrm{v},i}:=\bigl\{\,L^2+iL+j+1 \;\bigm|\; j\in\{0,1,\dots,L-1\}\,\bigr\}`,
      ...
      paragraph(["を定める。このとき次の 4 つが成り立つ。"]),
      list([
        [
          "各 ",
          math(String.raw`i`),
    ...
    proof: [
      ...
      paragraph([
        ...
        " への全単射である（全射は定義から）。全単射で写り合う有限集合の個数は等しいので ",
        math(String.raw`|E_{L,\mathrm{h},i}|=L`),
        " である。",
    ...
    statement: [
      ...
      list([
        ...
        [
          todo("未着手"),
          "「転送行列」の続き: ",
          math(String.raw`T\in M_{2^L}\bigl(\mathbb{Z}[x]\bigr)`),
          " を作り ",
          math(String.raw`Z_L=\operatorname{Tr}\bigl(T^L\bigr)`),
          " を示す。行配位と破れボンド数の分解までは上で済んでいる。",
        ],
        [
          todo("未着手"),
          "「固有値の代数性」: 特性多項式が ",
