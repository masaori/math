...
\end{aligned}`),
      ...
      paragraph([
        ...
        "一続きの式にはしない）。いずれの場合も、まず ",
        math(String.raw`k_0(\tau,\tau'')`),
        " が何であるかを決め、そのうえで ",
        math(String.raw`\varepsilon`),
        " の値を比べる。",
      ]),
      paragraph([
        ...
        math(String.raw`k`),
        " については ",
        math(String.raw`k<k_0<k_1`),
        " なので準備の第二を 2 回用いて ",
        math(String.raw`\tau(\pi(k))=\tau'(\pi(k))=\tau''(\pi(k))`),
        " である。ゆえに ",
        math(String.raw`D(\tau,\tau'')`),
        " は ",
        math(String.raw`k_0`),
...
\end{aligned}`),
      paragraph(["である。すなわち ", math(String.raw`\tau\prec\tau''`), " である。"]),
      paragraph([
        math(String.raw`k_1<k_0`),
        " の場合。",
        math(String.raw`k_1<k_0`),
        ...
        math(String.raw`k`),
        " については ",
        math(String.raw`k<k_1<k_0`),
        " なので同様に ",
        math(String.raw`\tau(\pi(k))=\tau'(\pi(k))=\tau''(\pi(k))`),
        " である。ゆえに ",
        math(String.raw`k_0(\tau,\tau'')=k_1`),
        " であり",
      ]),
      displayMath(String.raw`\begin{aligned}
...
\end{aligned}`),
      paragraph([
        "である。したがって ",
        math(String.raw`\varepsilon(\tau(\pi(k_0)))<\varepsilon(\tau''(\pi(k_0)))`),
        "（自然数の大小の推移律）であり、",
        math(String.raw`\varepsilon`),
        " が単射なので ",
        math(String.raw`\tau(\pi(k_0))\ne\tau''(\pi(k_0))`),
