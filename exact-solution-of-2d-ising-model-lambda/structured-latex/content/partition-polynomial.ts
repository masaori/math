...
export default defineBlocks([
...

  {
    ...
    statement: [
      ...
      displayMath(String.raw`E_L:=\{1,2,\dots,2L^2\}`),
      paragraph([
        "および、各番号に 2 つの頂点（その辺の両端）を割り当てる写像 ",
      ...
      displayMath(String.raw`e-1=2\bigl(iL+j\bigr)+d,\qquad i,j\in\{0,1,\dots,L-1\},\ d\in\{0,1\}`),
      paragraph([
        "の形にただ一通りに書ける（まず ",
        math(String.raw`2`),
        " で割って商 ",
        ...
        math(String.raw`j`),
        " を取る）。この ",
        math(String.raw`i,j,d`),
        " を用いて",
      ]),
      displayMath(
        String.raw`\partial_0(e):=(i,j),\qquad
\partial_1(e):=\begin{cases}(i+1,\,j)&(d=0)\\[2pt](i,\,j+1)&(d=1)\end{cases}`,
      ),
      paragraph([
        "と定める。ここで ",
