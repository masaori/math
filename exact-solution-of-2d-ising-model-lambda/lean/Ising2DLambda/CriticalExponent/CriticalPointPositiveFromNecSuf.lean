/- `claim_critical_point_positive` の具体版が必要十分版の特殊化として得られること。 -/
...
theorem criticalPoint_positive_from_necSuf
  ...
  obtain ⟨w, _, hsw⟩ := data.sqrtTwo_square
  ...
  obtain ⟨z, hz0, hz⟩ :=
    Ising2DLambda.NecSuf.CriticalExponent.criticalPoint_positive_necSuf
      (K := base.carrier) (w * w) w rfl hsCarrier
