...
theorem rationalLogOrderLE_ratSmul_le_ratSmul_of_le_of_nonpos_from_necSuf {r s : ℚ} (hrs : r ≤ s)
    {ν : RationalLogOrderGroup} (hν : rationalLogOrderLE ν 0) :
    rationalLogOrderLE (s • ν) (r • ν) :=
  NecSuf.ThermodynamicLimit.smul_le_smul_of_le_of_nonpos_necSuf rationalLogOrderLE
