...
2026-08-15 の tick 263 のレビューで、前 tick の「自由エネルギー密度の上からの評価」の本文と
SageMath を突き合わせた。五つの準備・本体の十二段・有限標本検査の範囲は一致していたが、
準備第四の体準同型と自然数冪の帰納段が四つの等号を一行へ圧縮していたため、一行一等号・
行末根拠の四段の鎖へ開き、前進前に main へ反映した。
