...
および章「固有値の代数性」（定義 36 件・主張 47 件・定理 2 件。行配位の辞書式順序・置換の符号・
...
| 層 | 状態 |
| --- | --- |
| 記述（構造化テキスト） | 上記の定義 59 件・主張 61 件・定理 3 件・注意 1 件（ラベルの数。合計 124 ラベル）。`npm run check` と `npm run build:pdf` が全通過 |
