 ...
 */
const cjkMainFont = process.env.ISING_LAMBDA_PDF_CJK_MAIN_FONT ?? "Hiragino Mincho ProN";
const cjkSansFont = process.env.ISING_LAMBDA_PDF_CJK_SANS_FONT ?? "Hiragino Sans";
...
\\title{2値セルオートマトンの内在構造 --- 局所規則から生じる数学の抽出${titleVersion}}
\\date{}
