  ...
  },
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        why: "ブロック型を有限分割上の一相更新と有限相の順序付き一巡更新として定義し、固定分割に対する一相更新を各ブロック内入力だけへの依存で特徴づけた。有限所属判定と同期更新との二セル反例を構造化記述し、SageMath の段別検算と人手証明に対応する Lean 具体版まで揃えた。Lean 必要十分版と具体版への導出は後続対象である。",
      },
      {
        kind: "path",
