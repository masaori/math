# 種 S6 — $\Phi_N$ の台の大きさが CA の代数的性質を測る
...
> **仮説 S6**: $\operatorname{supp}(\Phi_N)$ の増大の仕方は、CA 規則の**代数的特殊性**を測る。
...
## 5. 最初の検算（`sagemath/check/001_phi_support/` に置く）
...
| 既知 | Martin–Odlyzko–Wolfram が線形の場合を尽くしている | **命題 1・2 は既知に近い。新規性は仮説 S6 の側にしかない** |
