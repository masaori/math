...
# 式ペア: e1^3 - 3(e1 e2 - 3e3) - 6e3 = e1^3 - 3e1e2 + 9e3 - 6e3
...
for data in examples:
    ...
    assert e1**3 - 3 * (e1 * e2 - 3 * e3) - 6 * e3 == e1**3 - 3 * e1 * e2 + 9 * e3 - 6 * e3, data["name"]

print("RESULT: PASS — distributivity expands the repeated-pair substitution exactly")
