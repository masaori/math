...
# 式ペア: R_G(a)^2-S_{G,2}(a) = B_G(a)/Pbar_G(a)
...
for data in examples:
    for a in algebraic_evaluation_points:
        ...
        if polynomial_value != 0:
            ...
            left = reciprocal_sum**2 - reciprocal_square_sum
            right = second_coefficient_sum / polynomial_value
            assert left == right, (data["name"], a)
print("RESULT: PASS — division by the nonzero polynomial value isolates the reciprocal-pair sum")
