...
# 式ペア: R_G(a)^2 - sum_j (a-alpha_j)^-2 = 2 sum_{k<l} ((a-alpha_k)(a-alpha_l))^-1
...
for data in examples:
    for a in algebraic_evaluation_points:
        if data["polynomial"](a) != 0:
            ...
            assert reciprocal_sum**2 - reciprocal_square_sum == 2 * reciprocal_pair_sum, (data["name"], a)
print("RESULT: PASS — the reciprocal-sum square separates diagonal terms from unordered root pairs")
