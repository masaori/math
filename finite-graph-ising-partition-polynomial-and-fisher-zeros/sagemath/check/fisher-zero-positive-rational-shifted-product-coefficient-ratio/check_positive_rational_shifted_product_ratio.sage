...
# 式ペア: product_j (iota(q)-alpha_j) = iota(Z_G(q) / eta(Omega_G(d)))
...
print("RESULT: PASS — every shifted-root product equals the QQbar image of the positive-rational evaluation ratio")
