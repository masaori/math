...
# 式ペア: R_G^3 - S_{G,3} - q_3 U_{G,2,1} = T_{G,3}
...
for data in examples:
    for a in algebraic_evaluation_points:
        if data["polynomial"](a) != 0:
            ...
            assert R**3 - S3 - q3 * U == T3, (data["name"], a)
print("RESULT: PASS — the non-diagonal term is subtracted from the triple decomposition")
