...
```sh
for check_file in finite-graph-ising-partition-polynomial-and-fisher-zeros/sagemath/check/positive-rational-evaluation-at-most-configuration-count/check_*.sage; do
  sage "$check_file"
done
```
