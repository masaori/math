...
```sh
for f in finite-graph-ising-partition-polynomial-and-fisher-zeros/sagemath/check/partition-polynomial-degree-maximum-broken-edge-count/check_*.sage; do sage "$f"; done
```
