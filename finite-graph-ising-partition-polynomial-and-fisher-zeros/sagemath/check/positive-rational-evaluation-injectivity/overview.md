...
```sh
sage finite-graph-ising-partition-polynomial-and-fisher-zeros/sagemath/check/positive-rational-evaluation-injectivity/check_evaluation_point_uniqueness.sage
```
