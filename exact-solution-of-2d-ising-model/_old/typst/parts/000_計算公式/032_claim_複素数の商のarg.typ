...
#claim(none)[
  ...
  $
    ...
    cases(
      ...
      arg^([0, 2pi))(z_1) - arg^([0, 2pi))(z_2) + 2 pi & quad (-2 pi < theta_1 - theta_2 - 2 (n_1 - n_2) pi < 0)
    )
  $
  ...
  #proof[
    ...
    また、$-2 pi < theta_1 - theta_2 - 2 (n_1 - n_2) pi < 2 pi$ なので、以下のケースに分けて考える。
    ...
    b. $-2 pi < theta_1 - theta_2 - 2 (n_1 - n_2) pi < 0$ の時、
