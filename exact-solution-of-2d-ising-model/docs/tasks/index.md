...
| [free-energy-roadmap](free-energy-roadmap/) | 7章 | V=cV' から Onsager の自由エネルギー・熱力学極限までの章立て | 章 A・B・B2・C・D 完了。章 C′ は土台（013 章）まで完了、固有値部分が残り |
| [2026-07\_original-text-gaps](2026-07_original-text-gaps/) | 5 | Lean 形式化で見つかった原文の穴 5 件の一次情報（本文修正は別セッション担当） | 5 件とも解消済み（記録として保持） |
