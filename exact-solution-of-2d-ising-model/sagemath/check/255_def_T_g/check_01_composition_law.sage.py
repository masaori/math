...
_sage_const_253001 = Integer(253001); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_3 = Integer(3); _sage_const_1j = ComplexNumber(0, '1'); _sage_const_1en6 = RealNumber('1e-6'); _sage_const_8 = Integer(8)# 253-01: T_g（def_T_g）の合成則 T_A ∘ T_B = T_{AB} と、線型写像としての性質
#
