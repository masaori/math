...
# This file was *autogenerated* from the file /Users/masaori/git/masaori/math/.claude/worktrees/source-inconsistency/exact-solution-of-2d-ising-model/sagemath/check/041_claim_TV1_TV2_actions/check_02_hatY_column_vector.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1en3 = RealNumber('1e-3'); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0p0 = RealNumber('0.0'); _sage_const_1en8 = RealNumber('1e-8')# ---------------------------------------------------------
...
MISMATCH_FLOOR = _sage_const_1en3 
...
for M in SPIN_TEST_M:
    ...
    for params in SPIN_TEST_PARAMS:
        ...
        fixed_worst = {'V1': _sage_const_0p0 , 'V2': _sage_const_0p0 }
        typo_max = _sage_const_0p0 
        ...
        for mu in O.mu_range():
            ...
            sh2, ch2 = CDF(sinh(_sage_const_2  * K2s)), CDF(cosh(_sage_const_2  * K2s))
            lhs1 = E1 * Yh * E1inv
            lhs2 = E2 * Yh * E2inv
        ...
        all_ok = report("T_{(V1)^{1/2}}(hatY) 修正後列ベクトル", fixed_worst['V1'], tol=_sage_const_1en8 ) and all_ok
        all_ok = report("T_{V2}(hatY) 列ベクトル", fixed_worst['V2'], tol=_sage_const_1en8 ) and all_ok
