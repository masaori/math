...
# This file was *autogenerated* from the file check_01_Z_eq_trace.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1p0 = RealNumber('1.0')# 252-01: Z(J,J') = tr((V_1 V_2)^M)
#
...
for (M, N) in MN_PAIRS:
    for (J, Jp) in JJ_PAIRS:
        ...
        print("  M=%d N=%d J=%.6g J'=%.6g : Z=%.10e  tr=%.10e  rel=%.2e"
              % (M, N, J, Jp, lhs, rhs, abs(lhs - rhs) / max(_sage_const_1p0 , abs(lhs))))
