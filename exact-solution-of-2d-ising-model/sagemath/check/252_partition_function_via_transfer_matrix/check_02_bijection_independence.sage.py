...
# This file was *autogenerated* from the file check_02_bijection_independence.sage
from sage.all_cmdline import *   # import sage library

_sage_const_20250726 = Integer(20250726); _sage_const_3 = Integer(3); _sage_const_1en8 = RealNumber('1e-8')# 252-02: 行・列の番号と 𝔐 = Map({1,…,N},{-1,1}) の同一視（全単射）の取り方に依らないこと
#
...
rng = np.random.default_rng(int(_sage_const_20250726 ))
...
for (M, N) in MN_PAIRS:
    ...
    for (J, Jp) in JJ_PAIRS[:_sage_const_3 ]:
        ...
        differs = float(np.max(np.abs(V1a - V1b))) > _sage_const_1en8 
