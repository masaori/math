...
# This file was *autogenerated* from the file check_02_V_plus_on_psi.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0p0 = RealNumber('0.0'); _sage_const_1 = Integer(1)# ---------------------------------------------------------
...
for M in EVEN_M:
    for params in EVEN_PARAMS:
        ...
        w = {'diag': _sage_const_0p0 , 'eig': _sage_const_0p0 }
