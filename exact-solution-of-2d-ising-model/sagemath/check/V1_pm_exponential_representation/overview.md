# SageMath Check: 第一転送行列の一般生成子による指数表示

## 対象

**対象ラベル**: `V1_pm_exponential_representation` （structured-latex 側の安定識別子）
...
```bash
sage sagemath/check/V1_pm_exponential_representation/check_generator_substitution.sage
```
