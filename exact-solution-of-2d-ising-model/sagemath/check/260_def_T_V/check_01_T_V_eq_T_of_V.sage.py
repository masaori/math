...
_sage_const_254001 = Integer(254001); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_6 = Integer(6); _sage_const_1j = ComplexNumber(0, '1')# 260-01: T_{(V)} = T_V （V := (V_1^{(±)})^{1/2} V_2 (V_1^{(±)})^{1/2}）
#
