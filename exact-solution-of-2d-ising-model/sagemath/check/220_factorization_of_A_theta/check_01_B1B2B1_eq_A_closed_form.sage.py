...
# This file was *autogenerated* from the file sagemath/check/220_factorization_of_A_theta/check_01_B1B2B1_eq_A_closed_form.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0p0 = RealNumber('0.0'); _sage_const_0p3 = RealNumber('0.3'); _sage_const_1p0 = RealNumber('1.0'); _sage_const_2p5 = RealNumber('2.5'); _sage_const_0p7 = RealNumber('0.7'); _sage_const_2 = Integer(2)# ---------------------------------------------------------
...
for (K1, K2, tag) in param_sets():
    B2 = B2_of(K2)
    for th in [_sage_const_0p0 , _sage_const_0p3 , _sage_const_1p0 , _sage_const_2p5 , -_sage_const_0p7 , np.pi, _sage_const_2  * np.pi]:
        B1 = B1_of(th, K1)
