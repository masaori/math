...
# This file was *autogenerated* from the file sagemath/check/220_factorization_of_A_theta/check_02_B1B2B1_eq_A_from_operators.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1en8 = RealNumber('1e-8'); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4)# ---------------------------------------------------------
...
for (K1, K2, tag) in param_sets():
    ...
    for M in [_sage_const_2 , _sage_const_3 , _sage_const_4 ]:
        for mu in mu_range(M):
            ...
            rep.truth(resid < _sage_const_1en8 ,
