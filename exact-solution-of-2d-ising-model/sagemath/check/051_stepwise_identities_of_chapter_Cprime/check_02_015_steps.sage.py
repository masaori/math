...
# This file was *autogenerated* from the file check_02_015_steps.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_6 = Integer(6); _sage_const_7 = Integer(7); _sage_const_8 = Integer(8); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_1en12 = RealNumber('1e-12'); _sage_const_1en2 = RealNumber('1e-2'); _sage_const_1en6 = RealNumber('1e-6')# =========================================================================
...
for p in STEP_PARAMS:
    ...
    K1s_def = RDF(-log(tanh(K1)) / _sage_const_2 )
    K2s_def = RDF(-log(tanh(K2)) / _sage_const_2 )
    ...
    rows = {
        ...
        "gamma_2_nonzero Step0 (3) c_1 > 0": RDF(cosh(_sage_const_2  * K1)),
        "gamma_2_nonzero Step0 (3) s_1 > 0": RDF(sinh(_sage_const_2  * K1)),
        "gamma_2_nonzero Step0 (4) c_2 > 0": RDF(cosh(_sage_const_2  * K2)),
        "gamma_2_nonzero Step0 (4) s_2^* > 0": RDF(sinh(_sage_const_2  * K2s_def)),
    }
    S.add("gamma_2_nonzero Step0 s_2^* = prelude の s2s", RDF(sinh(_sage_const_2  * K2s_def)), P['s2s'])
    S.add("gamma_2_nonzero Step0 c_1 = prelude の c1", RDF(cosh(_sage_const_2  * K1)), P['c1'])
    S.add("gamma_2_nonzero Step0 s_1 = prelude の s1", RDF(sinh(_sage_const_2  * K1)), P['s1'])
    S.add("gamma_2_nonzero Step0 c_2 = prelude の c2", RDF(cosh(_sage_const_2  * K2)), P['c2'])
