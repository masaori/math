...
- 次の tick は「帰無モデル: 二部性からの回文性」のうち、二番目の主張
  「奇数側だけ反転する写像は全単射である」を、具体版・必要十分版・導出の 3 本で形式化する。
...
- 2026-08-14: 帰無モデル「二部性からの回文性」の最初の主張（辺の両端の座標和の偶奇）を、
  Lean の具体版・必要十分版・具体版の導出で形式化し、3 定理を検査対象へ登録した。
...
- **Lean の置き場所と最初の形式化は用意済み**（具体版 `Ising3DCut`、必要十分版
  ...
  「辺の両端の座標和の偶奇」の具体版・必要十分版・導出の 3 定理を登録済み。
