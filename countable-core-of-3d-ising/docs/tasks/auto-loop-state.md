...
- 2026-08-20 04:36: 自由エネルギー密度の最小性から、新標的「交差べき等式は極限量に対して必要でない反例」を台帳へ追加した。ずらした自由族で極限量は一致するが交差べき等式が破れる箱と評価点を厳密判定する。次は評価点の判定と本文の主張ブロックの記述。
