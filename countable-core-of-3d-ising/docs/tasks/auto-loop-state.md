...
- 2026-08-20 05:33: 反例標的の記述層を閉じた。評価点 2・箱 2 での交差べきの破れと末尾ずらしによる極限量の一致を束ね、交差べき等式が極限量に対して十分だが必要でないことを一つの主張として本文へ記述した。次は SageMath 検証。
