...
export default defineBlocks([
  {
      id: "three_dimensional_ising_semantics_heading",
      kind: "heading",
      level: 1,
    title: { text: "3次元Isingモデルのセマンティクスを持つもの" },
      labels: [],
    },

  {
      id: "model_finite_box_heading",
      kind: "heading",
      level: 2,
      title: { text: "自由境界の有限箱" },
      labels: [],
  ...
  {
      id: "model_finite_box_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: なし。出力: 箱・辺・端点・配位・破れ数・多重度。主定理・主張: 有限箱とその配位データ。"])],
    },
  ...
  {
      id: "model_bipartite_heading",
      kind: "heading",
      level: 2,
      title: { text: "二部性による自由境界の帰無モデル" },
      labels: [],
    },

  {
      id: "model_bipartite_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 自由境界の有限箱。出力: 奇数側反転、破れ数の補数化、回文性。主定理・主張: 多重度は回文である。"])],
    },
  ...
  {
      id: "model_bipartite_audit_heading",
      kind: "heading",
      level: 2,
      title: { text: "自由境界回文性の抽象化監査" },
      labels: [],
    },

  {
      id: "model_bipartite_audit_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 自由境界の具体的回文性と有限二部後続系。出力: 整数座標の算術が不要であること。主定理・主張: 回文性に整数の算術は要らない。"])],
    },
  ...
  {
      id: "model_periodic_heading",
      kind: "heading",
      level: 2,
      title: { text: "周期境界と奇数周期の障害" },
      labels: [],
    },

  {
      id: "model_periodic_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 有限周期後続系。出力: 奇数周期における非回文性。主定理・主張: 奇数周期では多重度は回文でない。"])],
    },
  ...
  {
      id: "model_null_data_heading",
      kind: "heading",
      level: 2,
      title: { text: "自由境界分配多項式の帰無データ" },
      labels: [],
    },

  {
      id: "model_null_data_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 多重度と回文性。出力: 分配多項式の値・係数・台・偶数性。主定理・主張: 分配多項式の台の両端は零と辺の本数である。"])],
    },
  ...
  {
      id: "model_finite_polynomial_heading",
      kind: "heading",
      level: 2,
      title: { text: "有限多項式に残る情報・潰れる情報" },
      labels: [],
    },

  {
      id: "model_finite_polynomial_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 分配多項式と数学章の有限代数。出力: Galois 上限、有理点からの復元、潰れる二点データ。主定理・主張: 相異なる有理点の素指数データは分配多項式を一意に決める。"])],
    },
  ...
  {
      id: "model_boundary_response_heading",
      kind: "heading",
      level: 2,
      title: { text: "境界応答多項式と外箱依存性" },
      labels: [],
    },

  {
      id: "model_boundary_response_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 多変数分配多項式と箱の包含。出力: 外箱独立性と全辺変数版の有限代数的性質。主定理・主張: 境界応答多項式は外箱に依存しない。"])],
    },
  ...
  {
      id: "model_limit_bridge_heading",
      kind: "heading",
      level: 2,
      title: { text: "有限箱列から極限量へ渡す橋" },
      labels: [],
    },

  {
      id: "model_limit_bridge_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 有理点における有限箱データの列。出力: 箱サイズ極限による唯一の脱出と等式移送。主定理・主張: 極限量は有限箱の列だけの関数である。"])],
    },
  ...
  {
      id: "model_coarse_graining_heading",
      kind: "heading",
      level: 2,
      title: { text: "粗視化の十分性と非必要性" },
      labels: [],
    },

  {
      id: "model_coarse_graining_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 多変数特殊化と極限量への橋。出力: 十分性、分配値粗視化、対称化極限量での非必要性。主定理・主張: 分配多項式の値による粗視化は極限量に対して十分である。"])],
    },
  ...
  {
    id: "model_sequence_relations_heading",
    kind: "heading",
    level: 2,
    title: { text: "有限箱列の一致関係と交差冪等式" },
    labels: [],
  },

  {
    id: "model_sequence_relations_heading_goal",
    kind: "remark",
    title: { text: "この節の入出力と主定理" },
    labels: [],
    habitat: "none",
    statement: [paragraph(["入力: 尾部一致、正の乗根、交差冪等式。出力: 項別・尾部・共終条件による極限移送。主定理・主張: 交差冪等式は箱サイズ極限の存在と一致に十分である。"])],
  },
  ...
  {
    id: "model_collision_core_heading",
    kind: "heading",
    level: 2,
    title: { text: "衝突判定と可算コアの最小性" },
    labels: [],
  },

  {
    id: "model_collision_core_heading_goal",
    kind: "remark",
    title: { text: "この節の入出力と主定理" },
    labels: [],
    habitat: "none",
    statement: [paragraph(["入力: 正の有理値上の粗視化。出力: 衝突による非十分性、左逆、素指数コア。主定理・主張: 可算コアは素指数データと一対一に対応する。"])],
  },
  ...
  {
      id: "model_invariant_counterexamples_heading",
      kind: "heading",
      level: 2,
      title: { text: "代数的不変量が極限で潰れる反例" },
      labels: [],
    },

  {
      id: "model_invariant_counterexamples_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: ずらした自由境界族。出力: 判別式・Galois 群・既約分解型・零点集合などの非必要性。主定理・主張: ずらした自由族による各反例。"])],
    },
  ...
  {
      id: "model_prediction_heading",
      kind: "heading",
      level: 2,
      title: { text: "二次元からの事前予言" },
      labels: [],
    },

  {
      id: "model_prediction_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 二次元境界応答多項式。出力: 偶部分グラフ有限和と分母を消去した Pfaffian。主定理・主張: 二次元の境界応答多項式は分母を消去した Pfaffian で書ける。"])],
    },
  ...
  {
      id: "model_realizable_heading",
      kind: "heading",
      level: 2,
      title: { text: "実現可能な Ising 列上の十分性" },
      labels: [],
    },

  {
      id: "model_realizable_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 極限量の存在点と実現可能な列・値。出力: 実現可能族上の非十分性証人。主定理・主張: 実際の Ising 有限箱データ上の非十分性の証人。"])],
    },
  ...
  {
      id: "model_eventually_constant_heading",
      kind: "heading",
      level: 2,
      title: { text: "末尾定数性と正の有理点の分類" },
      labels: [],
    },

  {
      id: "model_eventually_constant_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 有限箱の帰無データと冪差算術。出力: 点数乗表示、候補三点の導出、有理点一への分類。主定理・主張: 有限箱量が末尾で一定となる正の有理点は一に限られる。"])],
    },
  ...
  {
      id: "model_periodic_limit_heading",
      kind: "heading",
      level: 2,
      title: { text: "末尾周期性・有限値域・第二候補の障害" },
      labels: [],
    },

  {
      id: "model_periodic_limit_heading_goal",
      kind: "remark",
      title: { text: "この節の入出力と主定理" },
      labels: [],
      habitat: "none",
      statement: [paragraph(["入力: 末尾定数分類と交差冪等式。出力: 周期的・有限値域の分類と第二候補の必要条件。主定理・主張: 末尾周期的で極限量を持つ正の有理点は一だけである。"])],
    },
  ...
  {
        id: "soundness_bridge_claim_residue_class_values_differ_no_limit_quantity",
        kind: "claim",
        standing: "mainTheorem",
        title: { text: "剰余類ごとの定数値が二つ相異なるなら極限量は存在しない" },
        labels: ["claim_residue_class_values_differ_no_limit_quantity"],
        habitat: "R",
        realEscape:
          "結論が極限量の非存在なので、def_limit_quantity_from_finite_box_sequence の箱の大きさの極限をここで一度だけ参照する。使うのは ℝ の極限の一意性と、末尾で定数な部分列の極限がその定数に等しいことだけであり、上限・下限・積分・微分・無限和は使わない。",
        statement: [
          paragraph([
            "正の有理数 ",
            math(String.raw`q\in\mathbb Q_{>0}`),
            ...
            math(String.raw`0\le r<p`),
            " についての剰余類ごとの定数値を ",
            math(String.raw`c_r:=a_{L_0+r}(q)\in\mathbb R_{>0}`),
            " と置く（",
            ref("claim_eventually_periodic_residue_class_constant"),
            "）。ある ",
            math(String.raw`r,s`),
        ...
        proof: [
          paragraph([
            "極限量 ",
            math(String.raw`\alpha(q)\in\mathbb R_{>0}`),
            " が存在すると仮定する。",
            math(String.raw`0\le t<p`),
            " を任意にとり、部分列 ",
            math(String.raw`k\mapsto a_{L_0+t+kp}(q)`),
            " を考える。",
          ]),
          displayMath(
            String.raw`\begin{aligned}
    \lim_{k\to\infty}a_{L_0+t+kp}(q)&=\alpha(q) &&(\because\ \text{収束列の部分列は同じ極限へ収束する})\\
    a_{L_0+t+kp}(q)&=c_t\quad(k\in\mathbb N) &&(\because\ \blkref{claim_eventually_periodic_residue_class_constant})\\
    \lim_{k\to\infty}a_{L_0+t+kp}(q)&=c_t &&(\because\ \text{定数列の極限はその定数である})\\
    c_t&=\alpha(q) &&(\because\ \mathbb R\ \text{の極限の一意性})
    \end{aligned}`,
          ),
          paragraph([
            "この等式は ",
            math(String.raw`0\le t<p`),
            " のすべてについて成り立つので、とくに ",
            math(String.raw`c_r=\alpha(q)`),
            " かつ ",
            math(String.raw`c_s=\alpha(q)`),
            " であり、",
  ...
  {
        id: "soundness_bridge_claim_eventually_periodic_limit_quantity_only_at_one",
        kind: "claim",
        title: { text: "末尾周期的で極限量を持つ正の有理点は 1 だけである" },
        labels: ["claim_eventually_periodic_limit_quantity_only_at_one"],
        habitat: "R",
        realEscape:
          "極限量を参照するので、def_limit_quantity_from_finite_box_sequence の箱の大きさの極限を一度だけ引く。証明の残りは有限個の有理数の等式と場合分けだけであり、新たな脱出は加えない。",
        statement: [
          paragraph([
            math(String.raw`q\in\mathbb Q_{>0}`),
            " とし、有限箱の量の列 ",
        ...
        proof: [
          paragraph([
            ...
            math(String.raw`0\le r<p`),
            " について剰余類ごとの定数値を ",
            math(String.raw`c_r:=a_{L_0+r}(q)`),
            " と置く（",
            ref("claim_eventually_periodic_residue_class_constant"),
            "）。有限個の正の有理数 ",
            math(String.raw`c_0,\dots,c_{p-1}`),
            " について、すべてが等しいか、相異なる二つがあるかのいずれか一方だけが成り立つ。この二つの場合に分ける。",
          ]),
          paragraph([
            "相異なる二つ ",
            math(String.raw`c_r\ne c_s`),
            " がある場合、極限量は存在しない（",
            ref("claim_residue_class_values_differ_no_limit_quantity"),
            "）。これは極限量 ",
            math(String.raw`\alpha(q)`),
            " が存在するという仮定に反するので、この場合は起こらない。",
          ]),
          paragraph([
            "したがって ",
            math(String.raw`c_0=\dots=c_{p-1}`),
  ...
  {
        id: "soundness_bridge_claim_finitely_many_values_gives_eventually_constant",
        kind: "claim",
        title: { text: "有限個の値しかとらない列が極限量を持つなら末尾定数である" },
        labels: ["claim_finitely_many_values_gives_eventually_constant"],
        habitat: "R",
        realEscape:
          "極限量を参照するので、def_limit_quantity_from_finite_box_sequence の箱の大きさの極限を一度だけ引く。証明の残りは有限集合の元の個数の勘定と有理数の等号判定だけであり、新たな脱出は加えない。",
        statement: [
          paragraph([
            math(String.raw`q\in\mathbb Q_{>0}`),
            " とし、有限箱の量の列 ",
            math(String.raw`L\mapsto a_L(q)`),
            " のとる値の集合 ",
            math(String.raw`S:=\{a_L(q)\mid L\ge1\}`),
            " が有限集合であるとする。このとき極限量 ",
            math(String.raw`\alpha(q)`),
            "（",
            ref("def_limit_quantity_from_finite_box_sequence"),
            "）が存在するならば、この列は末尾定数である（",
            ref("def_eventually_constant_finite_box_sequence"),
            "）。",
          ]),
        ],
        proof: [
          paragraph([
            "まず ",
            math(String.raw`v\in S`),
            " であって ",
            math(String.raw`v\ne\alpha(q)`),
            " となるものを一つとり、集合 ",
            math(String.raw`I_v:=\{L\ge1\mid a_L(q)=v\}`),
            " が無限集合であると仮定して矛盾を導く。",
          ]),
          paragraph([
            math(String.raw`I_v`),
            " が無限集合ならば、その元を小さい順に並べて狭義単調増加な添字列 ",
            math(String.raw`k\mapsto L_k`),
            " が得られ、この添字列は際限なく大きくなる。部分列 ",
            math(String.raw`k\mapsto a_{L_k}(q)`),
            " は定数 ",
            math(String.raw`v`),
            " をとるので、その極限は ",
            math(String.raw`v`),
            " である。一方、際限なく大きくなる添字列に沿う部分列は元の列と同じ極限 ",
            math(String.raw`\alpha(q)`),
            " を持つ。極限の一意性より ",
            math(String.raw`v=\alpha(q)`),
            " となり、これは ",
            math(String.raw`v\ne\alpha(q)`),
            " に反する。",
          ]),
          paragraph([
            ...
            " が有限集合なので、そのような ",
            math(String.raw`v`),
            " は有限個しかなく、対応する有限個の有限集合の合併 ",
            math(String.raw`\bigcup_{v\in S,\,v\ne\alpha(q)}I_v`),
            " も有限集合である。この合併が空なら ",
            math(String.raw`L_0:=1`),
            " とおき、空でなければ合併の最大元に ",
            math(String.raw`1`),
            ...
            math(String.raw`L`),
            " について ",
            math(String.raw`a_L(q)\in S`),
            " かつ ",
            math(String.raw`a_L(q)\ne v`),
            "（",
            math(String.raw`v\ne\alpha(q)`),
            " なる各 ",
            math(String.raw`v\in S`),
            " について）であるから ",
            math(String.raw`a_L(q)=\alpha(q)`),
            " である。すなわち列は閾値 ",
            math(String.raw`L_0`),
            " 以後で値 ",
            math(String.raw`\alpha(q)`),
...

  {
        ...
        labels: ["remark_eventually_periodic_limit_quantity_reduces_to_one"],
        habitat: "R",
        realEscape:
          "極限量を参照するので、def_limit_quantity_from_finite_box_sequence の箱の大きさの極限を引くだけである。新たな脱出は加えない。",
        statement: [
          paragraph([
            "上の主張（",
            ref("claim_residue_class_values_differ_no_limit_quantity"),
            "）により、末尾周期的であって剰余類ごとの定数値が二つ以上相異なる正の有理点は、極限量を持たない。剰余類ごとの定数値がすべて一致する場合は末尾定数であり（",
            ref("claim_residue_class_values_agree_gives_eventually_constant"),
            "）、そのような正の有理点は ",
            math(String.raw`q=1`),
            " に限られる（",
            ref("claim_eventually_constant_only_at_one"),
            "）。したがって、末尾周期性から極限量の存在を得られる正の有理点は ",
            math(String.raw`q=1`),
            " だけである。どちらの場合に落ちるかは、閾値以後の代表箱についての有限個の有理数等式 ",
            math(String.raw`Z_L(q)^{\#V_{L'}}=Z_{L'}(q)^{\#V_L}`),
            " で判定できる（",
            ref("remark_residue_class_values_agree_is_decidable"),
            "）。",
          ]),
        ],
      }
