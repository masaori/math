  ...
  },
  {
    ...
    statement: [
      paragraph([
        ...
        "（",
        ref("def_finite_box_prime_exponent_sequence"),
        " の形の列。各項は点の個数と素指数データの組）が尾部同値であるとは、ある ",
      ...
      paragraph([
        ...
        " の大きい方がとれる）なので、有限箱の列の全体の上の同値関係である。定義に現れる量はすべて可算側（",
        math(String.raw`\mathbb N`),
        " と ",
        math(String.raw`\Lambda`),
        "）にあり、実数も極限も用いない。尾部同値類への射影は、列の有限接頭部（最初の有限個の項）の情報だけを忘れる粗視化である。",
      ]),
    ],
  },
