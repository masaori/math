...
\end{aligned}`,
  ...
  {
    id: "soundness_bridge_heading_residue_class_values_differ_no_limit_quantity",
    kind: "heading",
    level: 2,
    title: { text: "剰余類ごとの値が食い違うなら極限量は存在しない" },
    labels: [],
  },
  {
  ...
  },
  {
    ...
    proof: [
      ...
      paragraph([
        ...
        " も有限集合である。この合併に属さない最小の閾値 ",
        math(String.raw`L_0\ge1`),
        " をとると、",
        math(String.raw`L\ge L_0`),
        " なるすべての ",
        math(String.raw`L`),
