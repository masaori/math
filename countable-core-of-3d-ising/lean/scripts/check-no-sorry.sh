...
targets=(
  ...
  Ising3DCut.LimitQuantity.padicValRat_partitionValueAtOneHalfRat
  Ising3DCut.LimitQuantity.partitionValueAtOneHalfRat_cross_power_ne
  Ising3DCut.NecSuf.pow_ne_pow_of_pow_additive_index_mul_ne
  Ising3DCut.NecSuf.no_eventual_cross_power_identity_of_pow_additive_index_mul_ne
  Ising3DCut.LimitQuantity.eventually_periodic_at_one_half_power_identity_impossible_fromNecSuf
  Ising3DCut.LimitQuantity.eventually_periodic_at_one_half_power_identity_impossible
  Ising3DCut.NecSuf.pow_ne_pow_of_pow_additive_index_eq_one
  Ising3DCut.NecSuf.no_eventual_cross_power_identity_of_pow_additive_index_eq_one
  ...
  Ising3DCut.LimitQuantity.point_den_dvd_two_mul_base_den_pow_from_free_box
  Ising3DCut.LimitQuantity.point_den_dvd_two_mul_base_den_pow_of_rational_value_form
  Ising3DCut.LimitQuantity.rationalValueSeq_eq_brokenCountSum_div
  ...
  Ising3DCut.LimitQuantity.eq_one_of_cross_power_identity_from_free_box_numerator_connections
  ...
  Ising3DCut.NecSuf.common_root_implies_cross_power_equality
  Ising3DCut.LimitQuantity.posRoot_equality_implies_cross_power_equality_fromNecSuf
  ...
  Ising3DCut.NecSuf.dvd_mul_pow_sub_pow_of_dvd_mul_sub
  Ising3DCut.LimitQuantity.base_divisibility_of_rational_value_form_viaNecSuf
  Ising3DCut.LimitQuantity.eq_one_of_cross_power_identity_from_free_box_closed_viaNecSuf
  Ising3DCut.Prediction.exists_candidate_internal_edge_cover_at
  Ising3DCut.LimitQuantity.power_numerator_divisibility_of_base_divisibility_fromNecSuf
  ...
  Ising3DCut.LimitQuantity.eventually_periodic_limit_quantity_only_at_one
  Ising3DCut.NecSuf.eventuallyPeriodicLimit_onlyTarget
  Ising3DCut.LimitQuantity.eventually_periodic_limit_quantity_only_at_one_fromNecSuf
  Ising3DCut.LimitQuantity.eq_limit_of_infinite_level_set
  Ising3DCut.LimitQuantity.ising_value_eq_limitQuantity_of_infinite_level_set
  Ising3DCut.LimitQuantity.eventually_constant_of_finite_range
  Ising3DCut.LimitQuantity.ising_eventually_constant_of_finite_range
  Ising3DCut.NecSuf.eqLimit_of_infiniteLevelSet
  Ising3DCut.NecSuf.finiteRangeConvergent_eventuallyConstant
  Ising3DCut.LimitQuantity.ising_eventually_constant_of_finite_range_fromNecSuf
  ...
  Ising3DCut.LimitQuantity.tail_cross_power_failure_not_sufficient_for_limit_quantity
  Ising3DCut.NecSuf.cofinalPairFailure_of_divergentIndices
  Ising3DCut.NecSuf.cofinalPairFailure_and_noLimit
  Ising3DCut.LimitQuantity.alternating_crossPower_fails_on_adjacent_pair
  Ising3DCut.LimitQuantity.tail_cross_power_failure_not_sufficient_for_limit_quantity_viaNecSuf
  ...
  Ising3DCut.Prediction.disjoint_periodicSquareFiberInternalEdgesAt
  Ising3DCut.Prediction.biUnion_periodicSquareFiberInternalEdgesAt_subset_terminalsAt
  ...
  Ising3DCut.Prediction.mem_periodicSquarePairingsAt_iff
  Ising3DCut.Prediction.periodicSquareFiberInternalEdgesAt_mem_pairingsAt
  ...
  Ising3DCut.Prediction.fiberInternalEdgesAt_pairingsProductMatching
  Ising3DCut.Prediction.periodicSquareFiberToPairingsProduct_surjective
  ...
  Ising3DCut.Prediction.periodicSquarePairingsAt_eq_singleton_of_card_eq_two
  Ising3DCut.Prediction.card_periodicSquarePairingsAt_of_card_eq_two
  Ising3DCut.Prediction.two_mul_card_of_mem_periodicSquarePairingsAt
  Ising3DCut.Prediction.card_eq_two_of_mem_periodicSquarePairingsAt_of_card_eq_four
  Ising3DCut.Prediction.three_pairings_of_four_distinct
  Ising3DCut.Prediction.pair_containing_first_of_four
  Ising3DCut.Prediction.pairing_with_first_pair_of_four
