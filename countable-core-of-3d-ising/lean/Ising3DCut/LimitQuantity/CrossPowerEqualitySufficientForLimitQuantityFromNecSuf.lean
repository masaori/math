...
必要十分版へ渡す特殊化として導出できる。 -/
theorem cross_power_equality_is_sufficient_for_limit_quantity_fromNecSuf
  ...
  cross_power_equality_is_sufficient_for_limit_quantity_abstract
