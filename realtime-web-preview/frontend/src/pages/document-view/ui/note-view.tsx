import type { Note } from '@rwp/domain-model'
...
/** ノート1件の中身（タイトル + 本文 + 由来）。 */
const NoteBody = ({ note }: { note: Note }): ReactElement => (
  <article className="border-t border-dashed border-amber-300 py-2 first:border-t-0 first:pt-0">
    {note.title ? (
