...
# This file was *autogenerated* from the file kappa_offset.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_78 = Integer(78); _sage_const_5 = Integer(5); _sage_const_250 = Integer(250)# cycle 16 / T1: 全域木数 kappa と Monsky の和 S_n の間のオフセットを厳密に確認する。
#
...
def S_n_exact(Malpha, N, p):
    ...
    num = R(detM).polynomial_construction()[_sage_const_0 ] if hasattr(R(detM), 'polynomial_construction') else None
    ...
    poly = P0(poly)
    Phi = P0((x**N - _sage_const_1 ) // (x - _sage_const_1 ))          # 非自明指標に対応する因子
    res = Phi.resultant(poly)                # = prod_{zeta^N=1, zeta!=1} detM(zeta) （符号を除く）
    assert res != _sage_const_0 
    return ZZ(res).abs().valuation(p)


CASES = [
    # (名前, nv, edges, p, 期待される #V_X)
    ("banana(2頂点2重辺, 電圧0,1), p=2", _sage_const_2 , [(_sage_const_0 , _sage_const_1 , _sage_const_0 ), (_sage_const_0 , _sage_const_1 , _sage_const_1 )], _sage_const_2 ),
    ("C_3(3頂点閉路, 電圧0,0,1), p=3", _sage_const_3 , [(_sage_const_0 , _sage_const_1 , _sage_const_0 ), (_sage_const_1 , _sage_const_2 , _sage_const_0 ), (_sage_const_2 , _sage_const_0 , _sage_const_1 )], _sage_const_3 ),
    ("2頂点3重辺(電圧0,1,2), p=3", _sage_const_2 , [(_sage_const_0 , _sage_const_1 , _sage_const_0 ), (_sage_const_0 , _sage_const_1 , _sage_const_1 ), (_sage_const_0 , _sage_const_1 , _sage_const_2 )], _sage_const_3 ),
    ("bouquet(1頂点1ループ, 電圧1)… 対照, p=3", _sage_const_1 , [(_sage_const_0 , _sage_const_0 , _sage_const_1 )], _sage_const_3 ),
    ("C_2 x 2重辺付き(4頂点), p=2", _sage_const_4 , [(_sage_const_0 , _sage_const_1 , _sage_const_0 ), (_sage_const_1 , _sage_const_2 , _sage_const_0 ), (_sage_const_2 , _sage_const_3 , _sage_const_0 ), (_sage_const_3 , _sage_const_0 , _sage_const_1 ), (_sage_const_0 , _sage_const_2 , _sage_const_0 )], _sage_const_2 ),
]
...
for (name, nv, edges, p) in CASES:
    ...
    L0 = derived_graph_laplacian(nv, edges, _sage_const_1 )
    kX = kappa(L0)
    if kX == _sage_const_0 :
    ...
    for n in range(_sage_const_0 , _sage_const_5 ):
        ...
        predK = S - _sage_const_1  * n + ZZ(kX).valuation(p)
