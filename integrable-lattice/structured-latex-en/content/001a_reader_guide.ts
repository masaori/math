...
export default defineBlocks([
  {
    ...
    statement: [
      ...
      paragraph([
        ...
        "**They are a rearrangement of known mathematics, not new theorems.** Chapter 9 says, ",
  ...
  },
  {
    ...
    statement: [
      ...
      paragraph([
        ...
        "and Chapter 9 sets the propositions against the literature. A reader who wants only the dictionary ",
