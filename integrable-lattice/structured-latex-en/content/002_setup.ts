...
export default defineBlocks([
  {
    ...
    kind: "heading",
    level: 1,
    origin: { path: "structured-latex-en/content/002_setup.ts", ordinal: 1 },
  ...
  },
  {
    ...
    kind: "definition",
    origin: { path: "structured-latex-en/content/002_setup.ts", ordinal: 2 },
...
a^{\mathrm{red}}_L:=\prod_{\substack{z_1^{L}=\dots=z_d^{L}=1\\ P(z)\neq0}}P(z_1,\dots,z_d)`,
  ...
  },
  {
    ...
    kind: "claim",
    origin: { path: "structured-latex-en/content/002_setup.ts", ordinal: 3 },
  ...
  },
  {
    ...
    kind: "definition",
    origin: { path: "structured-latex-en/content/002_setup.ts", ordinal: 4 },
