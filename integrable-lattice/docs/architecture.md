...
```text
six-vertex | DWBC | determinant formula | known
six-vertex | reflecting boundary | determinant formula | known/unknown
RSOS        | finite size | character identity | known/unknown
loop/TL     | open boundary | T-system | unknown
```
