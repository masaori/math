...
current_cycle: 26           # cycle 0-26 完了。cycle 26 は 2026-08-02 に cycle 25 総括の「cycle 26 の焦点（案）」6 点から起こし、同日 rank:cycle26 で総括した。着手時に 6 点すべての前提を実測し、一次情報と一致することを確認してから起こしている。
