...
current_cycle: 24           # cycle 0-23 完了。cycle 24 は 2026-08-01 に cycle 23 総括の「cycle 24 の焦点（案）」4 点から起こした。
...
| 2 | 運用 | localize_english_edition | todo | | 英語版を main のローカライズモデルへ移す。`structured-latex-en/` の独立プロジェクト複製をやめ、`structured-latex/locales.config.ts` ＋ 翻訳ディレクトリへ寄せる。日英対応検査は自前実装でなくシステム側の構造照合に載せ替える。 |
...
| 6 | — | rank:cycle24 | todo | | 総括・MEMORY 更新・cycle 25 の焦点。 |
