...
export default defineBlocks([
  ...
  },
  {
    ...
    statement: [
      ...
      paragraph([
        ...
        math(String.raw`\pi(p,k)`),
        " is the period of the matrix power sequence ",
        math(String.raw`T^N\bmod p^k`),
        ". The period of the trace sequence ",
        math(String.raw`Z_N\bmod p^k`),
        " is a different quantity, and it is treated in ",
        ref("paper_prop_B"),
        ". The former is divisible by the latter, but the converse does not hold: there are actual examples in which the ratio is not ",
        math(String.raw`1`),
        ".",
      ]),
    ],
  ...
  },
  {
    ...
    habitat: "Z",
    verification: [
      "sagemath/check/cycle19_T3_trace_period",
      "sagemath/check/cycle40_trace_ladder_threshold",
    ],
    lean: [
      "IntegrableLattice.traceOrth_one_add_pow",
      "IntegrableLattice.isTracePeriodAt_mul_prime",
      ...
      list([
        [
          paragraph([
            ...
            ". A counterexample is ",
            math(String.raw`S=\begin{pmatrix}-2&-1\\-1&0\end{pmatrix}`),
            " with ",
            math(String.raw`p=2`),
            ". Here the elementary divisors of ",
            math(String.raw`G=\begin{pmatrix}2&-2\\-2&6\end{pmatrix}`),
            " are ",
            math(String.raw`2,4`),
            ", so ",
            math(String.raw`w^*=2`),
            ", while ",
            math(String.raw`t_2=1`),
            " and ",
            math(String.raw`t_3=4`),
            "; hence ",
            math(String.raw`t_3\nmid p\,t_2=2`),
            " at ",
            math(String.raw`k=2\le w^*`),
            ".",
          ]),
        ],
        [
