 ...
 */
/**
 * 英語版にしか無い**ファイル**（セグメント）。ここで認めても、その中のブロックは
...
export const TRANSLATION_ONLY_SEGMENTS: Readonly<Record<string, string>> = {
  ...
  "010_prior_art.ts":
    "先行研究との関係を 1 節へまとめるファイル。日本語版では既出性の判定が各命題の proof の中へ" +
    "散っているため、対応するファイルが無い。中身の理由は下の各ブロックの登録を見よ。",
};
...
export const TRANSLATION_ONLY_BLOCKS: Readonly<Record<string, string>> = {
  ...
  // --- 第 12 章: 先行研究との関係（locales/en/content/010_prior_art.ts） ---
