...
export const PROOF_DEBTS: readonly ProofDebt[] = [
  {
    ...
    reason:
      "命題 G′。cycle 21 step 4 で主張だけを本文へ入れた。原本（定理 X′）の証明は運んでいない。",
    grounds: {
      recordedIn: {
        report: "outputs/reports/cycle25_ops_guard_missing_proof_and_rotten_refs.md",
        quote: "`paper_055_theorem_theta_infinity`（命題 G′）は証明を持たない",
      },
      origin: {
        report: "outputs/reports/cycle19_T3_theta_infinity.md",
        proofMarker: "### 5.3 定理 X′（この族の閉形式）",
      },
    },
  },
  {
    block: "paper_056_theorem_ell2_family",
    reason: "命題 G″。原本（定理 Y′）の証明を運んでいない。",
    grounds: {
      recordedIn: {
        report: "outputs/reports/cycle25_ops_guard_missing_proof_and_rotten_refs.md",
        quote: "`paper_056_theorem_ell2_family`（命題 G″）は証明を持たない",
      },
      origin: {
        report: "outputs/reports/cycle20_T3_ell_equals_2.md",
        proofMarker: "### 5.2 定理 Y′",
      },
    },
  },
  {
    block: "paper_091_theorem_theta_padic",
    reason: "命題 J。原本（定理 J2 の桁定理）の証明を運んでいない。",
    grounds: {
      recordedIn: {
        report: "outputs/reports/cycle25_ops_guard_missing_proof_and_rotten_refs.md",
        quote: "`paper_091_theorem_theta_padic`（命題 J）は証明を持たない",
      },
      origin: {
        report: "outputs/reports/cycle19_T3_theta_ge_ell_plus_1.md",
        proofMarker: "### 2.2 定理 J2（桁定理）",
      },
    },
  },
  {
    block: "paper_101_theorem_s_infinity_decision",
    reason: "命題 K。原本（定理 W3 の判定手続き）の証明を運んでいない。",
    grounds: {
      recordedIn: {
        report: "outputs/reports/cycle25_ops_guard_missing_proof_and_rotten_refs.md",
        quote: "`paper_101_theorem_s_infinity_decision`（命題 K）は証明を持たない",
      },
      origin: {
        report: "outputs/reports/cycle20_T3_s_infinity_decision.md",
        proofMarker: "## 3. 定理 W3 — 判定手続き（一般の塔）",
      },
    },
  },
  {
    block: "paper_101_theorem_digit_branch",
    reason: "命題 R。原本（定理 L1 の桁枝再帰）の証明を運んでいない。",
    grounds: {
      recordedIn: {
        report: "outputs/reports/cycle25_ops_guard_missing_proof_and_rotten_refs.md",
        quote: "`paper_101_theorem_digit_branch`（命題 R）は証明を持たない",
      },
      origin: {
        report: "outputs/reports/cycle20_T3_cancellation_recursion.md",
        proofMarker: "### 2.2 定理 L1",
      },
    },
  },
  {
