 ...
 *     同じ理由は `locales/en/diff-rules.ts` の注記にも書いてある）。
  ...
  },
  {
    ...
    acknowledged: [
      ...
      },
      {
        item: "完全",
        reason:
          "report の「完全に決まる」という評価語に当たる内容を、本文は 4 係数を式として書き下すことで述べている。同じ内容の言い換えである。" +
          "なお「有限計算で判定できる」という言い方は、cycle 28 step 2 で塔の定義ブロックへ移った（命題 W はそれを参照する）。",
        grounds: {
          type: "paraphrase",
          reportQuote: "$d=-2$ と完全に決まる",
          bodyQuote: "非退化性の判定が有限計算で済むことは",
        },
      },
    ],
  },
