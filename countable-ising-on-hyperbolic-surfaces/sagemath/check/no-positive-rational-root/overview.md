...
- 範囲: 多重度係数表示、全頂点下向き配位の破れ辺数、定数項による正の有理評価の下界、評価値の正値性
...
| `check_constant_configuration_broken_edges.sage` | 全頂点下向き配位の破れ辺集合が空集合 | PASS | 全八グラフで空集合 |
| `check_constant_configuration_broken_count.sage` | 全頂点下向き配位の破れ辺数が零 | PASS | 全八グラフで零 |
| `check_zero_multiplicity_positive.sage` | 定数項の多重度が一以上 | PASS | 全八グラフで一以上 |
...
| `check_positive_evaluation.sage` | 正の有理評価が正 | PASS | 全八グラフ・全五評価点で正 |
