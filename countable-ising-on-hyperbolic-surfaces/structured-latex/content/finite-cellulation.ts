...
\in\mathbb Z`),
  ...
  },
  {
    ...
    habitat: "finite",
    verification: ["sagemath/check/oriented-closed-surface-cellulation", "sagemath/check/fixed-f7-matrix-cellulation", "sagemath/check/fixed-f7-double-cover"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_face_boundary_word"),
        " の入力である有限グラフ ",
...
\end{aligned}`),
  ...
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_thirteen_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百十三をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_thirteen_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-thirteen-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\bar q:=\iota_{\mathbb N,\mathbb Z}(q)`),
      paragraph(["と書けば、"]),
      displayMath(String.raw`\left(\bar p-2\right)\left(\bar q-2\right)=113
\quad\Longleftrightarrow\quad
(p,q)=(3,115)\ \text{または}\ (p,q)=(115,3).`),
      paragraph([
        math(String.raw`p,q\in\mathbb N_{>0}`),
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百十三の素数性、百十三の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=113
&\Longleftrightarrow ab=113
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,113)\ \text{または}\ (a,b)=(113,1)
&&\bigl(\because\ 113\text{ は素数であり、これらが正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,115)\ \text{または}\ (p,q)=(115,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
  ...
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_fourteen_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百十四をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_fourteen_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-fourteen-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百十四の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=114
&\Longleftrightarrow ab=114
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,114)\ \text{または}\ (a,b)=(2,57)\ \text{または}\\
&\hspace{5.7em}(a,b)=(3,38)\ \text{または}\ (a,b)=(6,19)\ \text{または}\\
&\hspace{5.7em}(a,b)=(19,6)\ \text{または}\ (a,b)=(38,3)\ \text{または}\\
&\hspace{5.7em}(a,b)=(57,2)\ \text{または}\ (a,b)=(114,1)
&&\bigl(\because\ 114\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,116)\ \text{または}\ (p,q)=(4,59)\ \text{または}\\
&\hspace{5.7em}(p,q)=(5,40)\ \text{または}\ (p,q)=(8,21)\ \text{または}\\
&\hspace{5.7em}(p,q)=(21,8)\ \text{または}\ (p,q)=(40,5)\ \text{または}\\
&\hspace{5.7em}(p,q)=(59,4)\ \text{または}\ (p,q)=(116,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_fifteen_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百十五をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_fifteen_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-fifteen-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百十五の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=115
&\Longleftrightarrow ab=115
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,115)\ \text{または}\ (a,b)=(5,23)\ \text{または}\\
&\hspace{5.7em}(a,b)=(23,5)\ \text{または}\ (a,b)=(115,1)
&&\bigl(\because\ 115\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,117)\ \text{または}\ (p,q)=(7,25)\ \text{または}\\
&\hspace{5.7em}(p,q)=(25,7)\ \text{または}\ (p,q)=(117,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_sixteen_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百十六をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_sixteen_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-sixteen-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百十六の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=116
&\Longleftrightarrow ab=116
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,116)\ \text{または}\ (a,b)=(2,58)\ \text{または}\\
&\hspace{5.7em}(a,b)=(4,29)\ \text{または}\ (a,b)=(29,4)\ \text{または}\\
&\hspace{5.7em}(a,b)=(58,2)\ \text{または}\ (a,b)=(116,1)
&&\bigl(\because\ 116\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,118)\ \text{または}\ (p,q)=(4,60)\ \text{または}\\
&\hspace{5.7em}(p,q)=(6,31)\ \text{または}\ (p,q)=(31,6)\ \text{または}\\
&\hspace{5.7em}(p,q)=(60,4)\ \text{または}\ (p,q)=(118,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_seventeen_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百十七をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_seventeen_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-seventeen-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百十七の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=117
&\Longleftrightarrow ab=117
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,117)\ \text{または}\ (a,b)=(3,39)\ \text{または}\\
&\hspace{5.7em}(a,b)=(9,13)\ \text{または}\ (a,b)=(13,9)\ \text{または}\\
&\hspace{5.7em}(a,b)=(39,3)\ \text{または}\ (a,b)=(117,1)
&&\bigl(\because\ 117\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,119)\ \text{または}\ (p,q)=(5,41)\ \text{または}\\
&\hspace{5.7em}(p,q)=(11,15)\ \text{または}\ (p,q)=(15,11)\ \text{または}\\
&\hspace{5.7em}(p,q)=(41,5)\ \text{または}\ (p,q)=(119,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_eighteen_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百十八をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_eighteen_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-eighteen-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百十八の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=118
&\Longleftrightarrow ab=118
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,118)\ \text{または}\ (a,b)=(2,59)\ \text{または}\\
&\hspace{5.7em}(a,b)=(59,2)\ \text{または}\ (a,b)=(118,1)
&&\bigl(\because\ 118\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,120)\ \text{または}\ (p,q)=(4,61)\ \text{または}\\
&\hspace{5.7em}(p,q)=(61,4)\ \text{または}\ (p,q)=(120,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_nineteen_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百十九をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_nineteen_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-nineteen-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百十九の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=119
&\Longleftrightarrow ab=119
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,119)\ \text{または}\ (a,b)=(7,17)\ \text{または}\\
&\hspace{5.7em}(a,b)=(17,7)\ \text{または}\ (a,b)=(119,1)
&&\bigl(\because\ 119\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,121)\ \text{または}\ (p,q)=(9,19)\ \text{または}\\
&\hspace{5.7em}(p,q)=(19,9)\ \text{または}\ (p,q)=(121,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
...
\end{aligned}`),
  ...
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_one_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十一をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_one_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-one-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十一の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=121
&\Longleftrightarrow ab=121
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,121)\ \text{または}\ (a,b)=(11,11)\ \text{または}\ (a,b)=(121,1)
&&\bigl(\because\ 121\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,123)\ \text{または}\ (p,q)=(13,13)\ \text{または}\ (p,q)=(123,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
  ...
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_two_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十二をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_two_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-two-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十二の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=122
&\Longleftrightarrow ab=122
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,122)\ \text{または}\ (a,b)=(2,61)\ \text{または}\\
&\hspace{5.7em}(a,b)=(61,2)\ \text{または}\ (a,b)=(122,1)
&&\bigl(\because\ 122\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,124)\ \text{または}\ (p,q)=(4,63)\ \text{または}\\
&\hspace{5.7em}(p,q)=(63,4)\ \text{または}\ (p,q)=(124,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_three_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十三をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_three_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-three-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十三の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=123
&\Longleftrightarrow ab=123
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,123)\ \text{または}\ (a,b)=(3,41)\ \text{または}\\
&\hspace{5.7em}(a,b)=(41,3)\ \text{または}\ (a,b)=(123,1)
&&\bigl(\because\ 123\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,125)\ \text{または}\ (p,q)=(5,43)\ \text{または}\\
&\hspace{5.7em}(p,q)=(43,5)\ \text{または}\ (p,q)=(125,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_four_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十四をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_four_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-four-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十四の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=124
&\Longleftrightarrow ab=124
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,124)\ \text{または}\ (a,b)=(2,62)\ \text{または}\\
&\hspace{5.7em}(a,b)=(4,31)\ \text{または}\ (a,b)=(31,4)\ \text{または}\\
&\hspace{5.7em}(a,b)=(62,2)\ \text{または}\ (a,b)=(124,1)
&&\bigl(\because\ 124\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,126)\ \text{または}\ (p,q)=(4,64)\ \text{または}\\
&\hspace{5.7em}(p,q)=(6,33)\ \text{または}\ (p,q)=(33,6)\ \text{または}\\
&\hspace{5.7em}(p,q)=(64,4)\ \text{または}\ (p,q)=(126,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_five_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十五をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_five_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-five-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十五の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=125
&\Longleftrightarrow ab=125
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,125)\ \text{または}\ (a,b)=(5,25)\ \text{または}\\
&\hspace{5.7em}(a,b)=(25,5)\ \text{または}\ (a,b)=(125,1)
&&\bigl(\because\ 125\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,127)\ \text{または}\ (p,q)=(7,27)\ \text{または}\\
&\hspace{5.7em}(p,q)=(27,7)\ \text{または}\ (p,q)=(127,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_six_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十六をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_six_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-six-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十六の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
...
&\hspace{5.7em}(p,q)=(5,44)\ \text{または}\ (p,q)=(8,23)\ \text{または}\\
&\hspace{5.7em}(p,q)=(9,20)\ \text{または}\ (p,q)=(11,16)\ \text{または}\\
&\hspace{5.7em}(p,q)=(16,11)\ \text{または}\ (p,q)=(20,9)\ \text{または}\\
&\hspace{5.7em}(p,q)=(23,8)\ \text{または}\ (p,q)=(44,5)\ \text{または}\\
&\hspace{5.7em}(p,q)=(65,4)\ \text{または}\ (p,q)=(128,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_seven_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十七をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_seven_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-seven-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\bar q:=\iota_{\mathbb N,\mathbb Z}(q)`),
      paragraph(["と書けば、"]),
      displayMath(String.raw`\left(\bar p-2\right)\left(\bar q-2\right)=127
\quad\Longleftrightarrow\quad
(p,q)=(3,129)\ \text{または}\ (p,q)=(129,3).`),
      paragraph([
        math(String.raw`p,q\in\mathbb N_{>0}`),
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十七の素数性と正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=127
&\Longleftrightarrow ab=127
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,127)\ \text{または}\ (a,b)=(127,1)
&&\bigl(\because\ 127\text{ は素数であり、これらが正の因子対の全体である}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,129)\ \text{または}\ (p,q)=(129,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
...
\end{aligned}`),
  ...
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_twenty_nine_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百二十九をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_twenty_nine_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-twenty-nine-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百二十九の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=129
&\Longleftrightarrow ab=129
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,129)\ \text{または}\ (a,b)=(3,43)\ \text{または}\\
&\hspace{5.7em}(a,b)=(43,3)\ \text{または}\ (a,b)=(129,1)
&&\bigl(\because\ 129\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,131)\ \text{または}\ (p,q)=(5,45)\ \text{または}\\
&\hspace{5.7em}(p,q)=(45,5)\ \text{または}\ (p,q)=(131,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_thirty_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百三十をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_thirty_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-thirty-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百三十の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=130
&\Longleftrightarrow ab=130
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,130)\ \text{または}\ (a,b)=(2,65)\ \text{または}\\
&\hspace{5.7em}(a,b)=(5,26)\ \text{または}\ (a,b)=(10,13)\ \text{または}\\
&\hspace{5.7em}(a,b)=(13,10)\ \text{または}\ (a,b)=(26,5)\ \text{または}\\
&\hspace{5.7em}(a,b)=(65,2)\ \text{または}\ (a,b)=(130,1)
&&\bigl(\because\ 130\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,132)\ \text{または}\ (p,q)=(4,67)\ \text{または}\\
&\hspace{5.7em}(p,q)=(7,28)\ \text{または}\ (p,q)=(12,15)\ \text{または}\\
&\hspace{5.7em}(p,q)=(15,12)\ \text{または}\ (p,q)=(28,7)\ \text{または}\\
&\hspace{5.7em}(p,q)=(67,4)\ \text{または}\ (p,q)=(132,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_thirty_one_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百三十一をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_thirty_one_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-thirty-one-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\bar q:=\iota_{\mathbb N,\mathbb Z}(q)`),
      paragraph(["と書けば、"]),
      displayMath(String.raw`\left(\bar p-2\right)\left(\bar q-2\right)=131
\quad\Longleftrightarrow\quad
(p,q)=(3,133)\ \text{または}\ (p,q)=(133,3).`),
      paragraph([
        math(String.raw`p,q\in\mathbb N_{>0}`),
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百三十一の素数性と正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=131
&\Longleftrightarrow ab=131
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,131)\ \text{または}\ (a,b)=(131,1)
&&\bigl(\because\ 131\text{ は素数であり、これらが正の因子対の全体である}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,133)\ \text{または}\ (p,q)=(133,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
  ...
  {
    id: "finite_cellulation_theorem_product_difference_one_hundred_thirty_two_hyperbolic_types",
    kind: "theorem",
    title: { text: "積差百三十二をもつ双曲正則型の分類" },
    labels: ["theorem_product_difference_one_hundred_thirty_two_hyperbolic_types"],
    habitat: "Z",
    verification: ["sagemath/check/product-difference-one-hundred-thirty-two-hyperbolic-types"],
    statement: [
      paragraph([
        ref("def_finite_cellulation_hyperbolic_regular_type_set"),
        " の有限セル分割データ ",
...
\end{aligned}`),
      paragraph([
        ...
        "、",
        math(String.raw`\bar p,\bar q\in\mathbb Z`),
        " である。この分類は自然数の加法、百三十二の正の因子対、および標準単射だけから得られ、除算、実数、複素数、極限、積分を用いない。",
      ]),
    ],
    proof: [
      paragraph([ref("theorem_hyperbolic_regular_type_degree_lower_bounds"), " より"]),
      ...
      displayMath(String.raw`\begin{aligned}
\left(\bar p-2\right)\left(\bar q-2\right)=132
&\Longleftrightarrow ab=132
&&\bigl(\because\ \text{標準単射は加法・乗法・等号を保存し反映する}\bigr)\\
&\Longleftrightarrow
(a,b)=(1,132)\ \text{または}\ (a,b)=(2,66)\ \text{または}\\
&\hspace{5.7em}(a,b)=(3,44)\ \text{または}\ (a,b)=(4,33)\ \text{または}\\
&\hspace{5.7em}(a,b)=(6,22)\ \text{または}\ (a,b)=(11,12)\ \text{または}\\
&\hspace{5.7em}(a,b)=(12,11)\ \text{または}\ (a,b)=(22,6)\ \text{または}\\
&\hspace{5.7em}(a,b)=(33,4)\ \text{または}\ (a,b)=(44,3)\ \text{または}\\
&\hspace{5.7em}(a,b)=(66,2)\ \text{または}\ (a,b)=(132,1)
&&\bigl(\because\ 132\text{ の正の因子対の全体}\bigr)\\
&\Longleftrightarrow
(p,q)=(3,134)\ \text{または}\ (p,q)=(4,68)\ \text{または}\\
&\hspace{5.7em}(p,q)=(5,46)\ \text{または}\ (p,q)=(6,35)\ \text{または}\\
&\hspace{5.7em}(p,q)=(8,24)\ \text{または}\ (p,q)=(13,14)\ \text{または}\\
&\hspace{5.7em}(p,q)=(14,13)\ \text{または}\ (p,q)=(24,8)\ \text{または}\\
&\hspace{5.7em}(p,q)=(35,6)\ \text{または}\ (p,q)=(46,5)\ \text{または}\\
&\hspace{5.7em}(p,q)=(68,4)\ \text{または}\ (p,q)=(134,3)
&&\bigl(\because\ p=a+2\text{ および }q=b+2\bigr).
\end{aligned}`),
    ],
  },
